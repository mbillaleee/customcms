 ...
 <div class="slider-area slider-style-1">
            <div class="preview-2">
                <div id="nivoslider" class="slides">	
                    <img src="{{asset('frontent-template1')}}/img/slider/1.jpg" alt="" title="#slider-1-caption1"/>
                    <img src="{{asset('frontent-template1')}}/img/slider/2.jpg" alt="" title="#slider-1-caption2"/>
                </div> 
