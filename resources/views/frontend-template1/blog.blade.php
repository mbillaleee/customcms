                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item overlay-hover">
                            <div class="single-blog-image">
                                <div class="overlay-effect">
                                    <a href="#">
                                        <img src="{{asset('frontent-template1')}}/img/blog/4.jpg" alt="">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item overlay-hover">
                            <div class="single-blog-image">
                                <div class="overlay-effect">
                                    <a href="#">
                                        <img src="{{asset('frontent-template1')}}/img/blog/5.jpg" alt="">
                                        <span class="class-date">Dec 21 <span>2015</span></span>
                                    </a>
                                </div>    
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item overlay-hover">
                            <div class="single-blog-image">
                                <div class="overlay-effect">
                                    <a href="#">
                                        <img src="{{asset('frontent-template1')}}/img/blog/6.jpg" alt="">
                                        <span class="class-date">Jan 24 <span>2016</span></span>
                                    </a>
                                </div>    
                            </div>
