            ...
            @csrf
                <div class="card p-5">
                    ...
                    <div class="mt-5">
                        ...
                        @if($page->image != null)<img src="{{asset('uploads/page/'.$page->image)}}" width="80" alt="{{$page->name}}">@endif
                    </div>
                    <div class="mt-5">
                    ...
                    <div class="mt-5">
                        ...
                        <input type="radio" name="status" value="1" {{ $page ? $page->status == 1 ? "checked" : "": ""   }}><span>Active</span>
                        <input type="radio" name="status" value="0" {{ $page ? $page->status == 0 ? "checked" : "": ""   }}><span>Inactive</span>
                    </div>
                    <div class="mt-5">
