...
@section('workspace')
    ...
    <section class="breadcrumb">
        <h1>Content</h1>
        <ul>
            <li><a href="#no-link">Content</a></li>
            ...
            @csrf
                <div class="card p-5">
                    <div class="mt-5">
                        ...
                        <input type="text" id="input" class="form-control" name="title" value="{{ $content->title }}" placeholder="Enter text here">
                    </div>
                    <div class="mt-5">
                        <label class="label block mb-2">Content</label>
                        <textarea type="text" class="form-control" rows="5" name="content" value="">{{ $content->content }}</textarea>
                    </div>
                    <div class="mt-5">
                        <label class="label block mb-2">Status</label>
                        <input type="radio" name="status" value="1" {{ $content ? $content->status == 1 ? "checked" : "": ""   }}><span>Active</span>
                        <input type="radio" name="status" value="0" {{ $content ? $content->status == 0 ? "checked" : "": ""   }}><span>Inactive</span>
                    </div>
                    <div class="mt-5">
