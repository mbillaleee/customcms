                ...
                <div class="aa-blog-content aa-blog-details">
                  <article class="aa-blog-content-single">                        
                    ...
                    <figure class="aa-blog-img">
                      <a href="#"><img src="{{asset('frontent-ecommerce')}}/img/fashion/3.jpg" alt="fashion img"></a>
                    </figure>
                    ...
                    <div class="comments">
                      <ul class="commentlist">
                        <li>
                          <div class="media">
                            <div class="media-left">    
                                <img class="media-object news-img" src="{{asset('frontent-ecommerce')}}/img/testimonial-img-3.jpg" alt="img">      
                            </div>
                        ...
                        <li>
                          <div class="media">
                            <div class="media-left">    
                                <img class="media-object news-img" src="{{asset('frontent-ecommerce')}}/img/testimonial-img-2.jpg" alt="img">      
                            </div>
                            <div class="media-body">
                             <h4 class="author-name">Charlie Balley</h4>
                             <span class="comments-date"> March 26th 2016</span>
