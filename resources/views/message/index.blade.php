...
@section('workspace')
    ...
    <section class="breadcrumb">
        <h1>Message</h1>
        <ul>
            <li><a href="#no-link">Message</a></li>
                ...
                <table class="table table_striped w-full mt-3">
                    <thead>
                        <tr>
                            ...
                            <th class="ltr:text-left rtl:text-right uppercase">Subject</th>
                            <th class="ltr:text-left rtl:text-right uppercase">Message</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->message }}</td>
                            <td class="flex">
                                <form class="" method="POST" action="{{route('message.destroy', $item->id)}}">
